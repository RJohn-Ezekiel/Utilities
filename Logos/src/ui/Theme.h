...
inline constexpr QColor toolbar       = QColor(0x25, 0x25, 0x25);
inline constexpr QColor statusBar     = QColor(0x25, 0x25, 0x25);
...
inline constexpr QColor selected      = QColor(0x3A, 0x3A, 0x3A);
inline constexpr QColor hover         = QColor(0x2E, 0x2E, 0x2E);
inline constexpr QColor errorBg       = QColor(0x2A, 0x2A, 0x2A);
inline constexpr QColor successBg     = QColor(0x2A, 0x2A, 0x2A);

[[nodiscard]] inline QColor accent()
{
    return QColor(0x7A, 0x7A, 0x7A);
}
